    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (intvalue){
            ...
            case 3:
                ...
                break;
            case 4:
                setContentView(R.layout.activity_dd3);
                break;
            case 5:
                setContentView(R.layout.activity_ee3);
                break;
            case 6:
                setContentView(R.layout.activity_ff3);
                break;
            case 7:
                setContentView(R.layout.activity_gg3);
                break;
            case 8:
                setContentView(R.layout.activity_hh3);
                break;
            case 9:
                setContentView(R.layout.activity_ii3);
                break;
            case 10:
                setContentView(R.layout.activity_jj3);
                break;
            case 11:
                setContentView(R.layout.activity_kk3);
                break;
